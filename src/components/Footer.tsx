            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-[60px] border-b border-white/10 pb-[60px] mb-[40px]">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-[15px] opacity-60 text-[14px]">
                        ...
                        <p className="cursor-pointer hover:text-[#FF6B35] transition-colors">Yetenek Havuzu</p>
                        <p className="cursor-pointer hover:text-[#FF6B35] transition-colors">Nasıl Çalışır?</p>
                    </div>
                </div>
                <div>
                    <h4 className="mb-[25px] font-[900]">İletişim</h4>
                    <p className="text-[13px] opacity-50 mb-[20px]">Sorularınız için bizimle iletişime geçin:</p>
                ...
                <div>
                    ...
                    <p className="mt-3 text-[12px] opacity-40 leading-relaxed">
